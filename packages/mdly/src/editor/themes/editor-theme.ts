...
const baseEditorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "scroll-m-20 text-3xl leading-[36px] font-medium tracking-tight [&:not(:first-child)]:mt-2 mb-2",
    h2: "scroll-m-20 text-2xl leading-[32px] font-medium tracking-tight [&:not(:first-child)]:mt-2 mb-2",
    h3: "scroll-m-20 text-xl leading-[28px] font-medium tracking-tight [&:not(:first-child)]:mt-1 mb-1",
    h4: "scroll-m-20 text-lg leading-[28px] font-medium tracking-tight [&:not(:first-child)]:mt-1 mb-1",
    h5: "scroll-m-20 text-lg leading-[28px] font-medium tracking-tight [&:not(:first-child)]:mt-1",
    h6: "scroll-m-20 text-base leading-[24px] font-medium tracking-tight [&:not(:first-child)]:mt-1",
  },
  paragraph: "leading-[28px] [&:not(:first-child)]:mt-2 [&:not(:last-child)]:mb-2",
  ...
  hr: "my-1 mx-0 h-0 border-0 border-t border-border cursor-pointer selected:ring-2 selected:ring-primary selected:ring-offset-2 selected:user-select-none",
